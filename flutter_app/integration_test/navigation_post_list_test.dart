...
void main() {
  ...
  group('Post List Navigation Flow Test', () {
    testWidgets('Login and navigate to profile then view post screen', (tester) async {
      ...
      // navigate to post list screen
      final postListButton = find.byIcon(Icons.list);
      await tester.tap(postListButton);
      await tester.pumpAndSettle(Duration(seconds: 5));

      // check for post list screen
